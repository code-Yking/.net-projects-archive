namespace DMP.My
{
    ...
    internal sealed class MyProject
    {
        ...
        {
            public DMP.Form1 m_Form1;
            public DMP.Form2 m_Form2;
            public DMP.Form3 m_Form3;
            [ThreadStatic]
            ...
            public DMP.Form1 Form1
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_Form1 = Create__Instance__<DMP.Form1>(this.m_Form1);
                    return this.m_Form1;
                }
                [DebuggerNonUserCode]
                set
                {
                    if (!ReferenceEquals(value, this.m_Form1))
                    {
                        ...
                        this.Dispose__Instance__<DMP.Form1>(ref this.m_Form1);
                    }
                }
            }

            public DMP.Form2 Form2
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_Form2 = Create__Instance__<DMP.Form2>(this.m_Form2);
                    return this.m_Form2;
                }
                [DebuggerNonUserCode]
                set
                {
                    if (!ReferenceEquals(value, this.m_Form2))
                    {
                        ...
                        this.Dispose__Instance__<DMP.Form2>(ref this.m_Form2);
                    }
                }
            }

            public DMP.Form3 Form3
            {
                [DebuggerNonUserCode]
                get
                {
                    this.m_Form3 = Create__Instance__<DMP.Form3>(this.m_Form3);
                    return this.m_Form3;
                }
                [DebuggerNonUserCode]
                set
                {
                    if (!ReferenceEquals(value, this.m_Form3))
                    {
                        ...
                        this.Dispose__Instance__<DMP.Form3>(ref this.m_Form3);
                    }
                }
            }
        }
